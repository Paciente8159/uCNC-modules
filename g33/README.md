...
```c
#define G33_ENCODER ENC0
#define ENCODER0_VIRTUAL_INDEX 1
#define ENCODER0_VIRTUAL_INDEX_CPR 600
#define ENCODER0_VIRTUAL_INDEX_OFFSET 0
```

`ENCODER0_VIRTUAL_INDEX_CPR` sets the encoder-count interval between synthetic
...
value from `ENCODER0_VIRTUAL_INDEX_CPR` and the runtime encoder resolution.
